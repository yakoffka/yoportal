                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Task Manager</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Планировщик задач на фреймворке laravel. Для использования необходима регистрация на сайте
                                    </p>
                                </div>
