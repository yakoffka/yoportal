...
namespace Yakoffka\AiracCalc {
     ...
     */        class AiracCalcServiceFacade {
         ...
         * @return int 
         * @static 
         */        public static function getCycleDay($dateString = null)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getCycleDay($dateString);
        }
                    /**
         ...
         * @return string 
         * @static 
         */        public static function getCurrentCycle($dateString = null)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getCurrentCycle($dateString);
        }
                    /**
         ...
         * @return string 
         * @static 
         */        public static function getPrevCycle($dateString = null)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getPrevCycle($dateString);
        }
                    /**
         ...
         * @return string 
         * @static 
         */        public static function getNextCycle($dateString = null)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getNextCycle($dateString);
        }
                    /**
         ...
         * @return string 
         * @static 
         */        public static function getPrevByAirac($airacCycle)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getPrevByAirac($airacCycle);
        }
                    /**
         ...
         * @return string 
         * @static 
         */        public static function getNextByAirac($airacCycle)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getNextByAirac($airacCycle);
        }
                    /**
         ...
         * @return \Illuminate\Support\Collection 
         * @static 
         */        public static function getEffectiveDates($start = '2016-01-07', $end = '2040-12-06')
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getEffectiveDates($start, $end);
        }
                    /**
         ...
         * @return void 
         * @static 
         */        public static function showEffectiveDates($start = '2016-01-07', $end = '2040-12-06')
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        $instance->showEffectiveDates($start, $end);
        }
                    /**
         ...
         * @return string 
         * @static 
         */        public static function getDayDate($cycleDay, $cycle)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getDayDate($cycleDay, $cycle);
        }
                    /**
         ...
         * @return bool 
         * @static 
         */        public static function isValidCycle($cycle)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->isValidCycle($cycle);
        }
                    /**
         * Получение количества циклов AIRAC в указанном (по умолчанию - в текущем) году
         *
         * @param \Yakoffka\AiracCalc\?string $year - год, в котором необходимо узнать количество циклов AIRAC
         * @return int 
         * @todo рефакторить?: получить значение через количество дней в году, дату первого дня первого цикла и високосность года
         * @static 
         */        public static function getNumberCyclesPerYear($year)
        {
                        /** @var \Yakoffka\AiracCalc\AiracCalcService $instance */
                        return $instance->getNumberCyclesPerYear($year);
        }
            }
    }
...
namespace  {
            ...
            class AiracCalc extends \Yakoffka\AiracCalc\AiracCalcServiceFacade {}
    }
